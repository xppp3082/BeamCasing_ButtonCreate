                                ...
                                foreach (GeometryObject obj in geoElement)
                                {
                                    ...
                                    if (null != solid)
                                    {
                                        ...
                                        foreach (FamilyInstance inst in castInstance)
                                        {
                                            ...
                                            XYZ inst_Up = new XYZ(instPt.X, instPt.Y, instPt.Z + 100);
                                            XYZ inst_Dn = new XYZ(instPt.X, instPt.Y, instPt.Z - 100);
                                            ...
                                            if (intersectCount > 0)
                                            {
                                                ...
                                                double TOP_update =intersect_UP.Z - (LocationPt.Z+cast_Max.Z);
                                                double BOP_update = (LocationPt.Z+cast_Min.Z)- intersect_DN.Z;
